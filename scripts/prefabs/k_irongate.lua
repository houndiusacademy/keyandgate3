...
return MakeWall("kyno_irongate", {wide="quagmire_park_gate", narrow="quagmire_park_gate"}, true, "park_key"),
MakeWallAnim("kyno_irongate_anim", {wide="quagmire_park_gate", narrow="quagmire_park_gate"}, true),
MakeInvItem("kyno_irongate_item", "kyno_irongate", "kyno_irongate", true),
MakeWallPlacer("kyno_irongate_placer", "kyno_irongate", {wide="quagmire_park_gate", narrow="quagmire_park_gate"}, true),
MakeWallPlacer("kyno_irongate_item_placer", "kyno_irongate", {wide="quagmire_park_gate", narrow="quagmire_park_gate"}, true)
